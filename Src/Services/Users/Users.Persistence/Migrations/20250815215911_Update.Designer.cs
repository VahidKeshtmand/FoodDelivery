...
namespace User.Persistence.Migrations
{
    ...
    [Migration("20250815215911_Update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Users.Domain.Entities.OtpCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Users.Domain.Entities.Customer", b =>
                {
                    b.HasBaseType("Users.Domain.Entities.User");
            ...
            modelBuilder.Entity("Users.Domain.Entities.DeliveryDriver", b =>
                {
                    b.HasBaseType("Users.Domain.Entities.User");
            ...
            modelBuilder.Entity("Users.Domain.Entities.RestaurantManger", b =>
                {
                    b.HasBaseType("Users.Domain.Entities.User");
            ...
            modelBuilder.Entity("Users.Domain.Entities.Customer", b =>
                {
                    b.HasOne("Users.Domain.Entities.User", null)
                        .WithOne()
                        .HasForeignKey("Users.Domain.Entities.Customer", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("Users.Domain.Entities.Address", "Addresses", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.OwnsOne("Users.Domain.ValueObjects.GeoLocation", "Location", b2 =>
                                {
            ...
            modelBuilder.Entity("Users.Domain.Entities.DeliveryDriver", b =>
                {
                    b.HasOne("Users.Domain.Entities.User", null)
                        .WithOne()
                        .HasForeignKey("Users.Domain.Entities.DeliveryDriver", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Users.Domain.ValueObjects.GeoLocation", "Location", b1 =>
                        {
            ...
            modelBuilder.Entity("Users.Domain.Entities.RestaurantManger", b =>
                {
                    b.HasOne("Users.Domain.Entities.User", null)
                        .WithOne()
                        .HasForeignKey("Users.Domain.Entities.RestaurantManger", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
