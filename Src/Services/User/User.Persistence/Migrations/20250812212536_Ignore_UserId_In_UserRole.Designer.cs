...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("User.Domain.Entities.UserRole", b =>
                {
                    b.HasOne("User.Domain.Entities.Customer", "Customer")
                        .WithMany("UserRoles")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("User.Domain.Entities.DeliveryDriver", "DeliveryDriver")
                        .WithMany("UserRoles")
                        .HasForeignKey("DeliveryDriverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("User.Domain.Entities.RestaurantManger", "RestaurantManger")
                        .WithMany("UserRoles")
